...
author: "Team Name: Shreya, Emily, Robert, Brogan"
date: "`r Sys.Date()`"
...
# Factors the possible regions, for the sake of seeing possible results
factor(plastic_data_all$region)
# Creates a frequency table based on region.
table(plastic_data_all$region)

# So, the region with the most coastal countries is Africa with 43.
...
plastic_data_all$total_mismanage_plastic <- plastic_data_all$population * plastic_data_all$mismanaged_plastic
# TODO 
# Finish excercise 2, all we did was the first subpoint. I might do it later today :)
